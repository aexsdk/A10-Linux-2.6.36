...
__attribute__((section("__versions"))) = {
	...
	{ 0x9af72914, "usb_wwan_dtr_rts" },
	{ 0x3e13ef00, "usb_wwan_tiocmset" },
	{ 0xc07ffddf, "usb_wwan_tiocmget" },
	{ 0x5e8f6c13, "usb_wwan_chars_in_buffer" },
	{ 0x28e6042b, "usb_wwan_set_termios" },
	{ 0xe74b6084, "usb_wwan_write_room" },
	{ 0x12f0f52d, "usb_wwan_write" },
	{ 0xd6078460, "usb_wwan_close" },
	{ 0xb2df4312, "usb_wwan_open" },
	{ 0x90cabd72, "usb_wwan_resume" },
	{ 0x230c3e1a, "usb_wwan_suspend" },
	{ 0x8cdbc8b6, "usb_wwan_release" },
	{ 0x5f0d935c, "usb_wwan_disconnect" },
	{ 0x4de17b38, "usb_wwan_startup" },
...
MODULE_ALIAS("usb:v19D2pFFFDd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFFCd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFFBd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFF1d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFF6d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFF7d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFF8d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFF9d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFEFd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFEEd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFEDd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFEBd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFECd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFEAd*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFE9d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v19D2pFFE8d*dc*dsc*dp*icFFiscFFipFF*");
...
MODULE_INFO(srcversion, "61180D163DB3C6F0E717BD7");
